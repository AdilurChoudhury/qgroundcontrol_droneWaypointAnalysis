...
Rectangle {
    ...
    property bool   _showVelocityWidget: false
    ...
    RowLayout {
        ...
        QGCToolBarButton {
            id: myCustomToolBarButton

            background: Rectangle {
                anchors.fill: parent
                color: qgcPal.buttonHighlight
                visible: (mouseArea.pressed || myCustomToolBarButton.checked)
            }

            Layout.preferredHeight: viewButtonRow.height
            height: Layout.preferredHeight
            width: height
            icon.source: "/custom/img/velocity.svg"
            ...
            MouseArea {
                ...
                onClicked: {
                    _root._showVelocityWidget = !_root._showVelocityWidget
                }
            }
        }
    }
